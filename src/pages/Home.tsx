...
import { Shield, Lock, Eye, Fingerprint, Wifi, AlertTriangle, ArrowRight, Users, Mail } from 'lucide-react';
import { supabase } from '../lib/supabaseClient';
import NetworkBackground from '../components/NetworkBackground';
import SEO from '../components/SEO';
import ufcLogo from '../assets/images/Brasão_Horizontal_cor_CAMPUS DE CRATEÚS 1.svg';
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        ...
                        >
                            ...
                            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                                ...
                                <div className="pt-4">
                                    <a href="https://www.researchgate.net/lab/Grupo-de-Pesquisa-em-Seguranca-da-Informacao-e-Preservacao-da-privacidade-Emerson-B-Tomaz" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-3 px-6 py-3 bg-emerald-50 text-emerald-700 font-bold rounded-xl hover:bg-emerald-100 hover:scale-105 transition-all border border-emerald-100 shadow-sm">
                                        <ResearchGateIcon className="w-5 h-5" />
                                        Acompanhe o GSIPP no ResearchGate
                                    </a>
                                </div>
                            </div>
                        </motion.div>
