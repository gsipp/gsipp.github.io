...
const Events = () => {
    ...
    const handleDelete = async (id: string) => {
        ...
        if (error) toast.error('Erro ao excluir evento: ' + error.message);
        else {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (editingEvent) {
            ...
            if (error) toast.error('Erro ao criar evento: ' + error.message);
            else toast.success('Evento agendado com sucesso.');
        }
                        ...
                        <div className="flex gap-3 w-full md:w-auto">
                            <div className="relative flex-1 md:w-64">
                                ...
                                <input
                                    ...
                                    className="pl-9 pr-4 py-2.5 rounded-xl border border-gray-200 text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500/20 w-full"
                                />
                            </div>
                            <button
                                onClick={() => openForm()}
                                className="bg-blue-500 hover:bg-blue-600 text-white px-5 py-2.5 rounded-xl font-medium flex items-center gap-2 transition-all shadow-lg hover:shadow-blue-500/30 whitespace-nowrap"
                            >
                                    ...
                                    {filteredEvents
                                        ...
                                        .map((event) => (
                                            <div key={event.id} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 flex gap-6 group hover:shadow-md transition-all relative overflow-hidden">
                                                <div className={`absolute top-0 left-0 w-1 h-full ${event.tipo === 'Defesa' ? 'bg-blue-500' : event.tipo === 'Palestra' ? 'bg-purple-500' : 'bg-blue-500'}`}></div>
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    <div className="flex items-center gap-2 mb-2">
                                                        <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider border flex items-center gap-1.5 ${event.tipo === 'Defesa' ? 'bg-blue-50 text-blue-600 border-blue-700' :
                                                            event.tipo === 'Palestra' ? 'bg-blue-50 text-blue-600 border-blue-100' :
                                                    ...
                                                    <h3 className="font-bold text-gray-900 text-xl mb-2 group-hover:text-blue-600 transition-colors truncate">{event.titulo}</h3>
                                                ...
                                                <div className="flex flex-col gap-2 justify-center opacity-0 group-hover:opacity-100 transition-all transform translate-x-2 group-hover:translate-x-0">
                                                    ...
                                                    <button onClick={() => setConfirmDelete(event.id)} className="p-3 bg-red-50 text-red-600 hover:bg-red-100 rounded-xl transition-all shadow-sm" title="Remover">
                                ...
                                <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-5 py-3 rounded-xl border border-gray-200 text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all font-bold text-xl"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <select
                                                ...
                                                className="w-full px-5 py-3 rounded-xl border border-gray-200 text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all bg-white"
                                            >
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full pl-12 pr-5 py-3 rounded-xl border border-gray-200 text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all"
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                className="w-full px-5 py-3 rounded-xl border border-gray-200 text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all"
                                            />
                                        </div>
                                        <div>
                                    ...
                                    {formData.tipo === 'Defesa' && (
                                        <div>
                                            <label className="block text-sm font-medium text-gray-700 mb-2 font-bold text-blue-600">Segunda Data de Defesa (Opcional)</label>
                                            <input
                                                type="date"
                                                value={formData.data_evento_2 || ''}
                                                onChange={e => setFormData({ ...formData, data_evento_2: e.target.value })}
                                                className="w-full px-5 py-3 rounded-xl border border-amber-100 bg-blue-50/30 text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all"
                                            />
                                        </div>
                                    )}
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            className="w-full px-5 py-3 rounded-xl border border-gray-200 text-gray-900 focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 outline-none transition-all resize-none leading-relaxed"
                                ...
                                <div className="bg-slate-900 text-white p-8 rounded-3xl shadow-xl space-y-8 sticky top-8">
                                    <div>
                                        <h3 className="text-xl font-bold mb-2 flex items-center gap-2">
                                            <UsersIcon className="w-5 h-5 text-blue-500" /> Vínculos
                                        </h3>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-9 pr-4 py-2 rounded-xl bg-slate-800 border border-slate-700 text-white text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                                        />
                                    </div>

                                    {formData.tipo === 'Defesa' && (
                                        <div className="space-y-4">
                                            <label className="block text-xs font-black text-blue-500 uppercase tracking-widest">Estudante Responsável</label>
                                            <select
                                    ...
                                    {formData.tipo === 'Defesa' ? (
                                        <div className="space-y-4">
                                            <label className="block text-xs font-black text-blue-500 uppercase tracking-widest">Banca / Orientadores</label>
                                        ...
                                        <div className="space-y-6">
                                            <div className="space-y-4">
                                                <label className="block text-xs font-black text-blue-500 uppercase tracking-widest">Palestrantes (Membros)</label>
                                                <div className="max-h-60 overflow-y-auto space-y-1 p-1 bg-slate-800/50 rounded-xl border border-slate-700 scrollbar-thin scrollbar-thumb-slate-700">
                                            ...
                                            <div className="space-y-4">
                                                <label className="block text-xs font-black text-blue-500 uppercase tracking-widest">Painelista Externo</label>
                                                <div className="relative">
                                    ...
                                    <div className="pt-2">
                                        <button
                                            type="submit"
                                            disabled={saving}
                                            className="w-full bg-blue-500 hover:bg-blue-600 text-slate-900 px-6 py-4 rounded-2xl font-black flex items-center justify-center gap-3 transition-all shadow-xl shadow-blue-500/30 disabled:opacity-50"
                                        >
